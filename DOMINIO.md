...
Un `.es` cuesta orientativamente entre 5 y 15 € al año (el precio del primer año
suele ser de oferta; mira el de renovación, que es el que pagarás siempre).
Registradores habituales en España: **DonDominio**, **IONOS**, **Hostinger**,
**Arsys**, **Namecheap**.

Al contratarlo:

- **Activa la privacidad del WHOIS** si el registrador la ofrece (evita que tu
  teléfono y dirección queden públicos). En `.es` suele venir de serie.
- **No contrates el hosting.** Solo el dominio. El alojamiento ya lo da GitHub
  Pages y es gratuito.
- Considera comprar también el `.com` y redirigirlo, para que nadie lo ocupe.
